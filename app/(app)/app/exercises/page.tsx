...
export default function Page() {
  ...
  useEffect(() => {
    async function t(){
      ...
      await fetch(env.api + "/exercise",{method: 'GET', headers:{
        authorization: 'Bearer ' + at
      } }).then( res => res.json()).then( res => setExercise(res.data));
    }
    t()
  }, [])
  ...
  return <div className="w-full min-h-screen flex flex-col justify-center items-center space-y-4  px-4 py-20 ">
